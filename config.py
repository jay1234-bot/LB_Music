...
API_ID = int(getenv("25933675", None))
API_HASH = getenv("b648426d4d353c3ef48b056e10ecbe4a", None)

# Get your token from @BotFather on Telegram.
BOT_TOKEN = getenv("7737328649:AAH65XQ08EZMn8yUeV9eL0FHnI8j3Uy2ZBs", None)

# Get your mongo url from cloud.mongodb.com
MONGO_DB_URI = getenv("mongodb+srv://astrohari09:<astrohari09>@cluster0.qmcrr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", None)
MUSIC_BOT_NAME = getenv("Music Bot", None)
PRIVATE_BOT_MODE = getenv("PRIVATE_BOT_MODE", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 900))

# Chat id of a group for logging bot's activities
LOGGER_ID = int(getenv("--1002477101018", None))
LOG_GROUP_ID = int(getenv("-1002477101018", None))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/krishanmusic")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/musicgroupchat1")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://envs.sh/AlW.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://envs.sh/AlW.jpg"
)
